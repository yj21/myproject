...
if($i%2==0)
	{		
		 ?>
		 <div style="font-size:25px; margin-left:200px; height:80px ;width:80px">
		 <img src="getimage.php?tid=<?php  echo urlencode($tid); ?>" width="80" height="80" />		
	...
	else
	{
		?>
				 ...
				 <div style="font-size:25px; margin-left:500px; height:80px;width:80px ;">
		 <img src="getimage.php?tid=<?php  echo urlencode($tid); ?>" width="80" height="80" />
		 <a href="smsg1.php?tid=<?php echo urlencode($tid); ?>&sid=<?php echo urlencode($sid); ?>"><?php echo urlencode($tname); ?></a><br>
	</div>
		<?php
	}
